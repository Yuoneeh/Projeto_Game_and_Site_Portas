...
func win_condition():
	if btn1_pressed == false && btn2_pressed == false && btn3_pressed == false && btn4_pressed == false:
		Global.stage_cleared = true
	elif btn1_pressed == true or btn2_pressed == true or btn3_pressed == true or btn4_pressed == true:
