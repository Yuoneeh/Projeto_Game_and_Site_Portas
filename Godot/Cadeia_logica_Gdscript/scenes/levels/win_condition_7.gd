...
func win_condition():
	if btn1_pressed == true or btn2_pressed == true or btn3_pressed == true or btn4_pressed == true:
		Global.stage_cleared = true
	elif btn1_pressed == false or btn2_pressed == false or btn3_pressed == false or btn4_pressed == false:
...
func _on_button_4_unpressed() -> void:
	btn4_pressed = false
	print("btn4_unpressed")
