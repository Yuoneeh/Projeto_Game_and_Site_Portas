...
func win_condition():
	if btn1_pressed == true && btn2_pressed == false or  btn1_pressed == false && btn2_pressed == true :
		Global.stage_cleared = false
	elif btn1_pressed == true && btn2_pressed == true or  btn1_pressed == false && btn2_pressed == false:
